...
bool ApMatrix::add_mul(ApMatrix *A, ApMatrix *B) {
    ...
    //PathIndex_MatrixShow(&m_old);
    //PathIndex_MatrixShow(&(A->m));
    //PathIndex_MatrixShow(&(B->m));
    ...
    /*std::cout << nvals_new << nvals_old << std::endl;
    std::cout << "Sum old new" << sum_old << " " << sum_new << std::endl;*/
    //std::cout << "============================" << std::endl;
